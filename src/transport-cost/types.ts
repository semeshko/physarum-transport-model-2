...
export type ConditionSource = "surface" | "smoothness" | "surface-and-smoothness" | "default-neutral";
...
export type CostDiagnostics = { readonly edgeCount: number; readonly explicitSpeedCount: number; readonly fallbackSpeedCount: number; readonly surfaceTaggedCount: number; readonly smoothnessTaggedCount: number; readonly provenanceCostConflictCount: number; readonly medianTravelTimeSeconds: number; readonly medianCostPerMeter: number };
