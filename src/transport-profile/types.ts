...
export type AccessDecisionKind = "allowed" | "denied";
export type AccessDecisionReason = "explicit-allow" | "explicit-deny" | "conditional-excluded" | "highway-default-allow" | "highway-default-deny";
export type AccessEvidence = { readonly sourceFeatureId: string; readonly key: string; readonly value: string; readonly reason: AccessDecisionReason; readonly allowed: boolean };
...
export type ProfileAccessDiagnostics = { readonly excludedByHighwayDefault: number; readonly excludedByAccessTag: number; readonly explicitlyAllowed: number; readonly conflictingProvenance: number; readonly conditionalAccessExcluded: number; readonly onewayTaggedNotEnforced: number };
