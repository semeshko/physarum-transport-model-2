...
export type AccessDecisionReason = "explicit-allow" | "explicit-restricted" | "explicit-deny" | "conditional-restricted" | "motorroad-default-deny" | "highway-default-allow" | "highway-default-restricted" | "highway-default-deny" | "category-default-allow" | "category-default-deny";
